...
/**
 * An example of a Helidon gRPC server using annotated
 * interfaces to define the services.
 *
...
public class Server {
    ...
    public static void main(String[] args) throws Exception {
        ...
        GrpcRouting routing = GrpcRouting.builder()
                // register the service implementation classes
                // the service definition will be created from
                // the annotations on the interface
                .register(StringServiceImpl.class)
                // GreetService is annotated with @Singleton as it maintains state between calls
