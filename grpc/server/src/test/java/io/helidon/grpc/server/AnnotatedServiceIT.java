...
import io.helidon.grpc.server.test.BidiServiceGrpc;
import io.helidon.grpc.server.test.ClientStreamingServiceGrpc;
import io.helidon.grpc.server.test.ServerStreamingServiceGrpc;
import io.helidon.grpc.server.test.Services;
import io.helidon.grpc.server.test.Services.TestRequest;
import io.helidon.grpc.server.test.Services.TestResponse;
import io.helidon.grpc.server.test.UnaryServiceGrpc;
...
public class AnnotatedServiceIT {
    ...
    public static void startServer() throws Exception {
        ...
        GrpcRouting routing = GrpcRouting.builder()
                                         ...
                                         .register(UnaryService.class)
                                         .register(ServerStreamingService.class)
                                         .register(ClientStreamingService.class)
                                         .register(BidiService.class)
                                         .build();
    ...
    public void shouldCallRequestResponse() {
        ...
        Services.TestResponse response = stub.requestResponse(TestRequest.newBuilder().setMessage("Foo").build());
